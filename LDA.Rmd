...
Coefficients of linear discriminants: Shows the linear combination of predictor variables that are used to form the LDA decision rule. for example, LD1 = 0.82*Sepal.Length + 1.53*Sepal.Width - 2.2*Petal.Length - 2.8*Petal.Width. Similarly, LD2 = 0.024*Sepal.Length + 2.164*Sepal.Width - 0.93*Petal.Length + 2.83*Petal.Width.
